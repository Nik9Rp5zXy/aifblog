    ...
    <form onSubmit={handleSubmit} className="p-8 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white tracking-tight">Projeyi Düzenle</h1>
            <p className="text-neutral-500 mt-1">ID: {project.id}</p>
          </div>
        </div>
        <button 
          type="submit" 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-neutral-950 p-6 border border-neutral-800 rounded-2xl">
            <label className="block text-sm font-medium text-neutral-400 mb-2">Kısa Açıklama</label>
            <textarea 
              rows={3}
          ...
          <div className="bg-neutral-950 p-6 border border-neutral-800 rounded-2xl">
            <label className="block text-sm font-medium text-neutral-400 mb-2">Detaylı İçerik</label>
            <textarea 
              rows={8}
