...
export function Navigation() {
  return (
    <nav className="fixed top-6 inset-x-0 z-50 flex justify-center px-4 pointer-events-none">
      <div className="pointer-events-auto flex items-center gap-8 px-8 py-4 bg-neutral-950 border border-neutral-800 rounded-full shadow-2xl transition-all duration-300 hover:border-neutral-700">
